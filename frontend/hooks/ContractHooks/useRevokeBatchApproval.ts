...
export const useRevokeBatchApproval = () => {
    ...
    async (batchName: string) => {
      ...
      try {
        ...
        const transaction = prepareContractCall({
          contract,
          method: "function revokeBatchApproval(string calldata batchName)",
          params: [batchName],
        });
        ...
        toast.success("Batch approval revoked successfully!");
        ...
        let errorMessage = "An error occurred while revoking approval.";
        ...
        if (err.reason === "BatchNotFound") {
          ...
          errorMessage = "You haven't approved this batch yet.";
